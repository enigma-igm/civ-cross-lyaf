...
skewerfile_create = '/Users/xinsheng/XSWork/CIV/Nyx_output/rand_skewers_z45_ovt_tau_new.fits'

skewerfile_origin = '/Users/xinsheng/XSWork/CIV/Nyx_output/rand_skewers_z45_ovt_tau_CIV.fits'
...
logZ = -3.5
savefig = '/Users/xinsheng/XSWork/CIV/figure/compare_skewers.pdf'
...
#### oden plot ####
ax1.plot(v_hires, oden[0], c='k', label = 'created lya')
...
ax2.plot(v_hires, tau_igm[0]*6, c='k', label = 'created lya')
#ax1.set_ylabel('Overdensity', fontsize=xylabel_fontsize)
...
ax3.plot(v_hires, ftot_hires[0], 'k', label='Perfect spectrum for created lya', drawstyle='steps-mid')#, alpha=0.6, zorder=10, color='red')
...
ax4.plot(v_hires_CIV, ftot_hires_CIV[0], 'k', label='Perfect spectrum for original lya', drawstyle='steps-mid')#, alpha=0.6, zorder=10, color='red')
