...
if compute_corr:
    for logM in logM_range:
        for tau_R in tau_R_range:
            ...
            tau_metal_file_lya = lyapath + 'rand_skewers_z45_ovt_tau_new.fits'
    ...
    if plottype == 'all':
        ...
        plt.xlim([-50, 2000])
        plt.savefig('/Users/xinsheng/civ-cross-lyaf/output/coor_CIV_lya_all.pdf')
        ...
        for logM in logM_range:
            ...
            plt.legend(frameon=False)
            plt.xlim([-50, 2000])
            plt.savefig('/Users/xinsheng/civ-cross-lyaf/output/coor_CIV_lya' + '_logM_' + '{:.2f}'.format(logM) + '.pdf')
    elif plottype == 'tau_R':
        for tau_R in tau_R_range:
            plt.figure(figsize=(12,8))
            for logM in logM_range:
            ...
            plt.legend(frameon=False)
            plt.xlim([-50, 2000])
            plt.savefig('/Users/xinsheng/civ-cross-lyaf/output/coor_CIV_lya' + '_tau_R_' + '{:.2f}'.format(tau_R) + '.pdf')
