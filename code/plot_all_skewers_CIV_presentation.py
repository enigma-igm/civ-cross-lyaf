...
fig, (ax6) = plt.subplots(1, figsize=(12, 4), sharex=True)
...
skewerfile_create = '/Users/xinsheng/civ-cross-lyaf/Nyx_output/rand_skewers_z45_ovt_tau.fits'

skewerfile_origin = '/Users/xinsheng/civ-cross-lyaf/Nyx_output/tau/rand_skewers_z45_ovt_xciv_tau_R_0.90_logM_9.90.fits'
...
logZ = -3.5
savefig = '/Users/xinsheng/civ-cross-lyaf/figure/skewers_presentation.pdf'
...
(oden, T, v_los), cgm_tup, tau_igm = CIV_lya.create_lya_forest(metal_par, metal_ske[[i]], logZ, fwhm, sampling=sampling)

v_lores_CIV, (ftot_lores_CIV, figm_lores_CIV, fcgm_lores_CIV), \
v_hires_CIV, (ftot_hires_CIV, figm_hires_CIV, fcgm_hires_CIV), \
(oden_CIV, T_CIV, v_los, x_metal_CIV), cgm_tup_CIV, tau_igm_CIV = CIV_lya.create_metal_forest_tau(metal_par_CIV, metal_ske_CIV[[i]], logZ, fwhm, metal_ion, sampling=sampling)
...
#ax6.plot(v_hires_CIV, ftot_hires_CIV[0], 'k', label='Perfect spectrum', drawstyle='steps-mid')#, alpha=0.6, zorder=10, color='red')
ax6.plot(v_lores, ftot_lores_noise, c='r', alpha=alpha_data, zorder=1, drawstyle='steps-mid')
ax6.set_xlabel('v [km/s]', fontsize=xylabel_fontsize)
#ax6.set_ylabel('Transmitted Flux', fontsize=xylabel_fontsize)
ax6.legend(fontsize=legend_fontsize, ncol=2, loc=1)
ax6.set_xlim([vmin, vmax])
#ax6.set_ylim([0.9, 1.12])
...
savefig = '/Users/xinsheng/civ-cross-lyaf/figure/skewers_presentation_noise_trans_lya.png'
plt.tight_layout()
